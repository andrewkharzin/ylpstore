...
use Andrewkharzin\Database\Models\Balance;
use Andrewkharzin\Database\Models\Coupon;
use Andrewkharzin\Database\Models\Order;
use Andrewkharzin\Database\Models\Product;
use Andrewkharzin\Database\Models\User;
use Andrewkharzin\Events\OrderCreated;
use Andrewkharzin\Exceptions\StoreException;
...
class OrderRepository extends BaseRepository
{
    ...
    public function storeOrder($request)
    {
        ...
        if ($response->isSuccessful()) {
            ...
            throw new StoreException('STORE_ERROR.PAYMENT_FAILED');
        }
    }
